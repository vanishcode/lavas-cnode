        ...
        <div
            ...
            <div v-if="title" class="app-sidebar-title" @click.stop="closeAndGo('/')">
                <span class="app-sidebar-title-left-icon">
                    ...
                    <v-icon v-else-if="title.iconLeft" class="may-be-left-icon-bug">{{ title.iconLeft }}</v-icon>
                </span>
...
$app-sidebar-title-left-icon-color = #fff
// 左侧触发滑动宽度
$swipe-width = 20px
...
.app-sidebar-content
    &.app-sidebar-content-right
        box-shadow -3px 0 8px 1px rgba(255, 255, 255, 0.4)
    ...
    .may-be-left-icon-bug
        color $app-sidebar-title-left-icon-color !important
